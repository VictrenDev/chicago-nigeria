                ...
                <motion.div variants={scaleInVariants} className="relative mb-8">
                    <motion.div variants={floatingVariants} animate="float" className="relative w-32 h-32 mx-auto">
                        ...
                        <motion.div
                            ...
                            <svg className="w-full h-full text-white/80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path
                                    strokeLinecap="round"
                        ...
                        <motion.div
                            ...
                            <svg className="w-full h-full text-white/60" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path
                                    strokeLinecap="round"
                                    strokeLinejoin="round"
                                    strokeWidth={1.5}
