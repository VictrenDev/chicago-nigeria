		...
		<>
			<main>
					...
					<section className="text-white md:text-black relative  md:bg-none bg-[url(/hero-image.webp)] bg-center bg-cover bg-no-repeat py-12">
						...
						<div className="container-custom grid grid-cols-1 md:grid-cols-2 items-center gap-8 ">
							...
							>
								...
								>
									Join the fastest-growing Nigerian community
									in Chicago. Connect, collaborate, and
									celebrate your heritage while building your
									future.
								</motion.p>
								{/* CTA hero section */}
								<motion.div
							...
							>
								...
								>
									<Image
										src={
											"/material-symbols-light-event-outline-sharp.webp"
										}
										alt="hero image"
										width={16}
										height={16}
				...
				>
					<motion.div className="text-center" variants={fadeInUp}>
						...
						<p className="mt-4 text-sm md:text-base">
							Everything you need to connect, grow, and thrive in
							the Chicago Nigerian community
						</p>
					</motion.div>
					{/* offer detail boxes  */}
					<motion.div
				...
				>
					<motion.div variants={slideInLeft}>
						...
						<p className="mt-4 lg:max-w-140 text-sm md:text-base">
							Be part of a thriving community that celebrates
							Nigerian culture while fostering professional growth
							and meaningful connections in the heart of Chicago.
						</p>
						...
						>
							...
							<p className="text-sm md:text-base">
								Unlock exclusive features and enhanced
								networking opportunities for just $20/month.
							</p>
							<ul className="list-disc list-inside text-sm md:text-base">
								<li>
									Priority event access and early bird
									discounts
								</li>
								<li>
									Featured business listings in marketplace
								</li>
				...
				>
					...
					>
						...
						<p className="text-sm md:text-base max-w-200 mx-auto">
							Your go-to guide for local Nigerian-owned businesses
							and services in Chicago. Find trusted professionals
				...
				<section className="min-h-screen flex flex-col items-center justify-center text-center bg-gradient-to-b from-white to-green-50 px-4 py-16 overflow-hidden relative">
					...
					>
						<Image
							className="absolute -left-100 -top-5 w-200 hidden md:block"
							src={"/podcast-mic1.webp"}
							alt="podcast image"
							width={4096}
							height={2731}
						/>
						...
						>
							Chicago Nigerians{" "}
							<span className="text-green-700">Podcast</span>
						</motion.h1>
						...
						>
							Join Us For Stories, Culture, And Community On Our
							All-New Chicago Nigerians Podcast — Available On All
							Major Platforms.
						</motion.p>

						<motion.p
							variants={fadeInUp}
							className="text-green-700 font-semibold mb-10"
						>
				...
				>
					<div className="container-custom grid grid-cols-1 md:grid-cols-2 gap-20 py-20">
						...
						>
							<Image
								src={
									"/african-american-woman-checking-social-media-phone.webp"
								}
						...
						>
							...
							<p className=" lg:max-w-140 text-sm md:text-lg  mt-2">
								...
								 , we&apos;ll manage your presence across
				...
				<section className="py-20 px-6 bg-white text-center overflow-hidden">
					...
					>
						...
						>
							Highlights From{" "}
							<span className="text-green-700">Naija @65</span>{" "}
							Celebration
						</motion.h2>
						...
						>
							Relive the unforgettable moments from our recent
							independence celebration in Chicago.
						</motion.p>
					...
					>
						...
						<h2 className=" text-4xl md:text-6xl font-bold">
							...
							<span className="text-[#00FF95]">
								Chicago Nigerian Family
							</span>
							?
						</h2>
						<p className="text-sm md:text-base">
							Don&apos;t wait! Start connecting, networking, and
							growing with the most vibrant Nigerian community in
							Chicago. 
						</p>
						<motion.div
			...
			>
				<section className="grid grid-cols-1 md:grid-cols-3 gap-12 text-sm">
					...
					>
						...
						<p className="">
							Connecting Nigerians in Chicago through culture,
							community, and commerce. Building bridges between
