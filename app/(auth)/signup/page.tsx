              ...
              <fieldset className="space-y-4 mt-8">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-500">
                      Sell products or services in the marketplace
                    </p>
                  </div>
                </div>
                {registrationType === "vendor" && (
              ...
              <button
                ...
                className={`${
                  isSubmitting
                    ...
                    : "bg-[var(--primary-color)]"
                } text-white py-3 rounded-lg flex justify-center items-center gap-2 w-full mt-8 mb-4 hover:bg-[var(--primary-color)]/90 disabled:opacity-50 transition-all duration-200`}
              >
                {isSubmitting ? (
                  <>
