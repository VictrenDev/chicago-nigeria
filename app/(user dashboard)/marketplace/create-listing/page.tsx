              ...
              <div className={`${getStepAnimationClass()} w-full `}>
                <fieldset className="space-y-4 mt-8 pb-4 ">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-xs my-1">
                      Choose the category that best describes your item or
                      service
                    </p>
                    <select
              ...
              <div className={`${getStepAnimationClass()} w-full`}>
                ...
                <fieldset className="space-y-4 mt-8 bg-white">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-xs my-1">
                      Add up to 8 photos. First photo will be your main listing
                      image.
                    </p>
                  ...
                  <div className="flex items-start gap-3 border border-green-400 bg-green-50 rounded-md p-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Review your listing details below and submit for
                        approval
                      </p>
                    </div>
                  </div>
                ...
                <div className="mx-auto bg-white rounded-2xl">
                  ...
                  <div className="space-y-1 text-sm">
                    <p>
                      ...
                      <span className="text-gray-800">{listingCategory}</span>
                    </p>
                    <p>
                      <span className="font-medium text-gray-600">
                        Condition:
                      </span>{" "}
                      <span className="text-gray-800">{listingCondition}</span>
                    </p>
                    <p>
                      <span className="font-medium text-gray-600">
                        Location:
                      </span>{" "}
                      <span className="text-gray-800">{listingLocation}</span>
                    </p>
                    <p>
                      <span className="font-medium text-gray-600">
                        Contact:
